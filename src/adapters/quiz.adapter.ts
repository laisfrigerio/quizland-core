...
const externalQuestionToInternal = (
  ...
  return {
    ...
    hasToShowAnswerDetails:
      isTrainingMode(mode) && hasAnswerDetails(answerDetails),
...
export const externalQuizConfigToInternal = (
  ...
  return {
    ...
    questions: questions.map((question) =>
      externalQuestionToInternal(question, quizType),
    ),
    level: quizLevel,
